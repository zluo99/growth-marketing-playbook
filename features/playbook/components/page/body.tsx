...
import { ErrorBoundary, TabError } from "@/components/ErrorBoundary"
...
function TabContent({ tabId }: { tabId: TabId }) {
	...
	const name = tab_display_names[tabId]

	return (
		<ErrorBoundary fallback={<TabError name={name} />}>
