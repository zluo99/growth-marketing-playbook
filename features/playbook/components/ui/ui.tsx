...
import { clamp_value, lerp_value } from "@/lib/dom"
...
export const createUnknownMetricLogger = () => (token: string) => token
	...
	return (
		<span
			...
			className={cn(
				...
				ui.radius.control,
				tone === "ai" ? ui.ai.stepBadge : tone === "orange" ? ui.ai.stepBadgeOrange : ui.metrics.pillSecondary,
				className
			)}
		>
			{number}
