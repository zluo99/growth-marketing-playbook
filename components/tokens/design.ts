...
export type AccentTone = "red" | "orange" | "yellow" | "green" | "blue" | "indigo" | "purple" | "neutral"
...
const glow = {
	...
	rainbow:
		"mix-blend-normal dark:mix-blend-screen bg-[radial-gradient(150%_64%_at_50%_0%,var(--glow-ai-lift)_0%,transparent_55%),radial-gradient(110%_48%_at_10%_8%,var(--glow-ai-cyan)_0%,transparent_65%),radial-gradient(110%_52%_at_50%_4%,var(--glow-ai-indigo)_0%,transparent_62%),radial-gradient(110%_48%_at_90%_8%,var(--glow-ai-gold)_0%,transparent_65%)]",
} as const
...
const ai = {
	...
	stepBadgeOrange: join_classes(
		"bg-[color:var(--accent-orange-bg)]",
		"border-[color:var(--accent-orange-border-strong)]",
		"text-[color:var(--accent-orange-fg)]"
	),
...
} as const satisfies Record<AccentTone, { track: string; fill: string }>
...
export type DesignTokens = typeof ui
