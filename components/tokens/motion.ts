...
const springs = {
	strong: { stiffness: 460, damping: 44, mass: 0.9 },     // snappy with slight overshoot — arrows, bar indicator
	pill: { stiffness: 700, damping: 60, mass: 0.72 },       // responsive, critically damped — full-width pill slide
	pillCompact: { stiffness: 1100, damping: 60, mass: 0.6 }, // tighter feel for compact/header nav pills
	enter: { stiffness: 520, damping: 46, mass: 0.9 },       // smooth entry — overlays, expanding panels
} as const
